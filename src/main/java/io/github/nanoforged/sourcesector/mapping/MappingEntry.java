...
public final class MappingEntry {
    ...
    /**
     * 值语义相等：全部字段一致视为同一条目（生成/合并结果可整体比对）。
     *
     * @param obj 对比对象
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MappingEntry other)) {
            return false;
        }
        return kind == other.kind
                && Objects.equals(ownerObfuscatedName, other.ownerObfuscatedName)
                && Objects.equals(ownerNamedName, other.ownerNamedName)
                && Objects.equals(obfuscatedName, other.obfuscatedName)
                && Objects.equals(intermediaryName, other.intermediaryName)
                && Objects.equals(namedName, other.namedName)
                && Objects.equals(descriptor, other.descriptor)
                && Objects.equals(comment, other.comment);
    }

    /**
     * 与 {@link #equals(Object)} 一致的全字段哈希。
     *
     * @return 哈希值
     */
    @Override
    public int hashCode() {
        return Objects.hash(kind, ownerObfuscatedName, ownerNamedName, obfuscatedName,
                intermediaryName, namedName, descriptor, comment);
    }
}